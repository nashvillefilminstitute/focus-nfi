  ...
  return (
    <div className={`post-card ${post.featured?"featured":""}`}>
      ...
      <div style={{padding:16}}>
        ...
        <p style={{fontSize:14,lineHeight:1.7,color:"#ddd",marginBottom:12,whiteSpace:"pre-wrap",fontWeight:300}}>{post.content}</p>
...
function ComposePost({ currentUser, onPost, onClose }) {
  ...
  async function submit() {
    ...
    const newPost = {
      ...
      content, tags: postType==="poll"?[...tags,"Poll"]:tags,
    ...
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal slide-up">
        ...
        <textarea value={content} onChange={e=>setContent(e.target.value)}
          ...
          rows={4} style={{resize:"none",marginBottom:14,fontSize:14,lineHeight:1.6}}/>
        ...
        <div style={{display:"flex",gap:10,justifyContent:"flex-end",marginTop:8}}>
          ...
          <button className="btn-primary" onClick={submit} disabled={!content.trim()||loading} style={{opacity:content.trim()&&!loading?1:0.5}}>
